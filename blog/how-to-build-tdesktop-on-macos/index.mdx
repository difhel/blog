...
description: A short guide on how to avoid Git errors when cloning large repositories and build Telegram Desktop for Mac OS faster than in the official guide.
authors: difhel
image: ./cover.png
tags: [macos, telegram]
